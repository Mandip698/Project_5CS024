...
from vote.views import change_password, index, about, contact, dashboard, login_view, verify_otp, logout_view, resend_otp, vote_poll, submit_vote, forgot_password_request, reset_password_after_otp, profile_view, edit_profile
